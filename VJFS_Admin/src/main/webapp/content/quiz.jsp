  	...
  	<div class="container">
	  	...
	  	<div class="row">
	  		...
	  		<div class="col-xs-6">
				...
				<ul>
					<li class="list-group-item" id="question_1_id"><a href="question_text.jsp">Question 1</a></li>
					<li class="list-group-item" id="question_2_id"><a href="question_text.jsp">Question 2</a></li>
					<li class="list-group-item" id="question_3_id"><a href="question_multiplechoice.jsp">Question 3</a></li>
				</ul>
